package com.forecast.weather.widgets;
...
import com.forecast.weather.activities.MainActivity;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String TAG = TimeWidgetProvider.class.getSimpleName();

    private static final String ACTION_UPDATE_TIME = "com.forecast.weather.UPDATE_TIME";
