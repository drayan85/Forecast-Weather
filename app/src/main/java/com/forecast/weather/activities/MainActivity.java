...
import com.forecast.weather.AlarmReceiver;
import com.forecast.weather.Constants;
import com.forecast.weather.R;
import com.forecast.weather.adapters.ViewPagerAdapter;
import com.forecast.weather.adapters.WeatherRecyclerAdapter;
import com.forecast.weather.fragments.RecyclerViewFragment;
import com.forecast.weather.models.Weather;
import com.forecast.weather.tasks.GenericRequestTask;
import com.forecast.weather.tasks.ParseResult;
import com.forecast.weather.tasks.TaskOutput;
import com.forecast.weather.utils.UnitConvertor;
import com.forecast.weather.widgets.AbstractWidgetProvider;
import com.forecast.weather.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private List<Weather> twoDaysAfterWeather = new ArrayList<>();
    private List<Weather> threeDaysAfterWeather = new ArrayList<>();
    private List<Weather> fourDaysAfterWeather = new ArrayList<>();
    private List<Weather> fiveDaysAfterWeather = new ArrayList<>();
    ...
    public WeatherRecyclerAdapter getAdapter(int id) {
        ...
        if (id == 0) {
            ...
            weatherRecyclerAdapter = new WeatherRecyclerAdapter(this, twoDaysAfterWeather);
        } else if(id == 3) {
            weatherRecyclerAdapter = new WeatherRecyclerAdapter(this, threeDaysAfterWeather);
        } else if(id == 4) {
            weatherRecyclerAdapter = new WeatherRecyclerAdapter(this, fourDaysAfterWeather);
        } else {
            weatherRecyclerAdapter = new WeatherRecyclerAdapter(this, fiveDaysAfterWeather);
        }
    ...
    private void updateTodayWeatherUI() {
        ...
        Log.d(TAG, "updateTodayWeatherUI: ");
    ...
    public ParseResult parseLongTermJson(String result) {
        ...
        try {
            ...
            final String code = reader.optString("cod");
            if ("404".equals(code)) {
                if (twoDaysAfterWeather == null) {
                    twoDaysAfterWeather = new ArrayList<>();
            ...
            fiveDaysAfterWeather = new ArrayList<>();
            fourDaysAfterWeather = new ArrayList<>();
            threeDaysAfterWeather = new ArrayList<>();
            twoDaysAfterWeather = new ArrayList<>();
            longTermTodayWeather = new ArrayList<>();
            longTermTomorrowWeather = new ArrayList<>();
    ...
    private void updateLongTermWeatherUI() {
        ...
        Bundle bundleTwoDaysAfter = new Bundle();
        bundleTwoDaysAfter.putInt("day", 2);
        RecyclerViewFragment recyclerViewFragmentTwoDaysAfter = new RecyclerViewFragment();
        recyclerViewFragmentTwoDaysAfter.setArguments(bundleTwoDaysAfter);
        viewPagerAdapter.addFragment(recyclerViewFragmentTwoDaysAfter, getString(R.string.two_days_after));

        Bundle bundleThreeDaysAfter = new Bundle();
        bundleThreeDaysAfter.putInt("day", 3);
        RecyclerViewFragment recyclerViewFragmentThreeDaysAfter = new RecyclerViewFragment();
        recyclerViewFragmentThreeDaysAfter.setArguments(bundleThreeDaysAfter);
        viewPagerAdapter.addFragment(recyclerViewFragmentThreeDaysAfter, getString(R.string.three_days_after));

        Bundle bundleFourDaysAfter = new Bundle();
        bundleFourDaysAfter.putInt("day", 4);
        RecyclerViewFragment recyclerViewFragmentFourDaysAfter = new RecyclerViewFragment();
        recyclerViewFragmentFourDaysAfter.setArguments(bundleFourDaysAfter);
        viewPagerAdapter.addFragment(recyclerViewFragmentFourDaysAfter, getString(R.string.four_days_after));

        Bundle bundleFiveDaysAfter = new Bundle();
        bundleFiveDaysAfter.putInt("day", 5);
        RecyclerViewFragment recyclerViewFragmentFiveDaysAfter = new RecyclerViewFragment();
        recyclerViewFragmentFiveDaysAfter.setArguments(bundleFiveDaysAfter);
        viewPagerAdapter.addFragment(recyclerViewFragmentFiveDaysAfter, getString(R.string.five_days_after));
